...
func (d *db) Create(ctx context.Context, user user.User) (string, error) {
	...
	d.logger.Debug("covert InsertID to ObjectID")
...
func (d *db) Delete(ctx context.Context, id string) error {
	...
	if result.DeletedCount == "0" {
		return fmt.Errorf("nor found")
	}

	d.logger.Tracef("Mathched %d documents and Modified %d documents", result.MatchedCount, result.ModifiedCount)
